<nav class="navbar navbar-expand-lg navbar-light bg-light">
    <div class="container-fluid">
        <a class="navbar-brand" href="#section-main">
      ...
      <div class="collapse navbar-collapse nav-item-align" id="navbarNavAltMarkup">
        <div class="navbar-nav">
          ...
          <a class="nav-link fs-5 active" href="/auth">Login</a>
        </div>
      </div>
    </div>
</nav>
...
<section id="section-about" class="d-flex justify-content-center align-items-center">
    ...
    <div class="col">
        <div class="card">
            <div class="d-flex justify-content-center mt-3">
                <img src="https://media.discordapp.net/attachments/755811797239333059/938772368397058068/118942799_368290460849380_7150962584455342817_n.png?width=500&height=500" alt="Kyaw" class="profile-pic border border-light border-2"/>
            </div>
            <div class="card-body text-white">
                ...
                <div class="sperate-line"></div>
                <p class="fs-5">
                    I am currently going to <a href="https://www.htl-leonding.at/">HTL Leonding</a><br>
                    I like doing sports and sleeping.<br>
                    Anime enjoyer
                </p>
            </div>
            <div class="card-footer lead text-white">
                Socials:
                <a href="https://www.instagram.com/a_stn14/" target="_blank">
                    <button type="button" class="btn btn-primary">
                        Instagram <img src="https://img.icons8.com/ios/30/000000/instagram-new--v1.png" alt="Instagram Icon"/>
                    </button>
                </a>
